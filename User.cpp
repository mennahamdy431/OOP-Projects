...
{
    return name;    //get the name of the user
}

void User::setPassword(string pass)
{
    password = pass;    //set the password of the user
}

string User::getPassword()
{
    return password;    //gets user's password
}
...
{
    age = Age;    //set the user's age
}

int User::getAge()
{
    return age;    //get user's age
}
